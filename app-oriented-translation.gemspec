...
Gem::Specification.new do |s|
  ...
  s.description = "Design-only source gem for Oriented Translation: a governed human surface over " \
                  ...
                  "modification proposals the design surfaced. No implementation. Private."
  s.authors     = ["CBI Business Transactions, LLC"]
  s.license     = "LicenseRef-DataYoursSoftwareMine-1.0"
  s.files       = Dir["lib/**/*", "docs/**/*", "README.md", "LICENSE", "*.gemspec"]
  s.require_paths = ["lib"]
