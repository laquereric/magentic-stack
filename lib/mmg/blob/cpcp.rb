    ...
    module Cpcp
      ...
      def register!
        ...
        ::RailsCpcp.project(model: "Blob") do
          operation "blob.put", direction: :push, params: %w[operationId bytes],
            summary: "Store bytes; returns the sha256 digest that names them",
        ...
        { ok: true, operations: %w[blob.put blob.get blob.stat blob.list] }
      end
    end
  end
end
