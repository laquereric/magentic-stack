...
// Drives SwitchYard.offline's real egress gate (apps/switchyard-offline/shared)
...
import { validateTarget, egress, isAllowedOrigin } from '../../apps/switchyard-offline/shared/egress.js';
...
const report = {
  ...
  tool: 'tooling/offline/offline_boundary_test.mjs + apps/switchyard-offline/shared/egress.js',
