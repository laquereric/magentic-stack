...
// free. Refresh source is the genai-prices data pin
// (upstreams/manifests/genai-prices.pin.json); the overlay lives in
// gems/adapters/genai-prices and writes into the config-owned JSON.
// ROLE=config still owns llm_catalog.json; do not put a second table here.
//
