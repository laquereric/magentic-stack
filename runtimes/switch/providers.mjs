...
//
// WHY THIS IS NOT JUST THE VENDORED LIST: apps/switchyard-offline is a Chrome
...
import { buildHeaders, egress as vendoredEgress } from '../../apps/switchyard-offline/shared/egress.js';
