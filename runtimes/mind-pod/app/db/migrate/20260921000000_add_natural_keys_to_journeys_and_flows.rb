...
# Carried from gems/vv-base/db/migrate. mind-pod keeps its own schema for
# the canonical homes -- ADR 0063 amendment 2026-09-04b, each application
# owns its persistence -- so an ADR 0074 migration has to land in both or
# this database never gets the columns the loader requires.
