...
| closed | 1, 2, 3, 14, 16, 21, 24, 42, 44, 47, 51, 52, 53, 54, 55, 56, 57, 58, 60, 62, 63, 66, 67, 71, 74, 76, 77, 78, 79, 80, 64, 65, 88, 89, 90, 93, 92, 61, 96, 12, 95, 99 | 42 rows |
...
| 99 | ~~Nothing gates the one file whose prose IS the product~~ | **CLOSED.** `check_mind_prompt.py` extracts the `MindCognition` class docstring (the system prompt), pins sha256+chars, forbids gap-62 FALSE/MISCLASSIFIED substrings, requires the TRUE claims. `check_boundary` still skips docstrings (correct for code). Did not change the prompt. Findings: [`GAP99.md`](GAP99.md) | — | closed |
