...
PageShell
  ...
  RefusalNotice
    payload: trigger="Request heat-alert map activation before effect eligibility"; heading="Activation will be refused in the current state"; reason="Cooling Access Site is explorable only. OB-019 is declared rather than verified; the after-hours dispute is open; P6 authorization and P7 outcomes references are unavailable; no SemanticActivation or ActabilityReceipt is present."; remediation="Clarify the disputed condition, obtain attestation and authorization references, verify the binding, then create activation and receipt records."; override="No override is available."
```
...
PageShell
  ...
  ScopeTrail
    payload: ordered-scope="City of Rivulet › Harbor District › 2026 Heat Safety Programme"; movement="Current decision scope"; editable="no"
  RefusalNotice
    payload: trigger="Amina requested Heat Alert Map Activation"; heading="Effect refused: Cooling Access Site is not effect-eligible"; reason="The source definition is active and explorable, but the after-hours access dispute is open, agreement is not evidenced for planning, OB-019 is not verified, P6 authorization and P7 outcomes references are unavailable, and neither SemanticActivation nor ActabilityReceipt is present."; remediation="Clarify the disputed condition, obtain attestation and authorization references, verify the binding, then create activation and receipt records."; override="The workbench will not simulate or imply activation."
  PanelFrame
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Submission lacking concept reference, artifact digest, or P5 provenance IRI"; heading="Revision refused: its governed source cannot be established"; reason="A DefinitionRevision must pin the normative artifact by digest and relate the concept to P5 provenance by IRI. Missing references cannot be replaced by copied content or narrative assurance."; remediation="Supply the missing digest or provenance IRI from the relevant sibling source, then resubmit."; override="No narrative substitute is accepted."
```
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Request effect before OB-019 is verified"; heading="Effect refused: declared binding is not verified binding"; reason="An active and attested definition permits plan assessment, not effect. SemanticActivation, ActabilityReceipt, P7 outcomes reference, and verified OperationBinding are still required."; remediation="Complete binding verification and then assess activation prerequisites."; override="No status value may be edited to bypass verification."
```
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Any required evidence reference becomes unavailable or verification ceases to pass before request evaluation"; heading="Activation refused: the displayed effect basis is no longer complete"; reason="Effect eligibility is evaluated at request time. A stale binding, missing authorization/outcomes reference, or non-passing required verification record invalidates the effect request."; remediation="Refresh the governing records and evidence references; do not rely on an earlier readiness display."; override="No cached readiness result authorizes an effect."
```
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Attempt to start translation without active source concept, source scope, target scope, or mapping artifact reference"; heading="Translation refused: referent or scope movement is not reviewable"; reason="A target expression cannot stand in for source governed meaning. The source concept, source-to-target scope movement, and mapping artifact reference must be available together."; remediation="Supply the missing source, scope, or mapping reference and re-evaluate translation readiness."; override="No researcher can accept a target-only translation."
```
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Attempt to submit with missing mapping proof or without source-to-target scope movement"; heading="Translation review refused: the relationship is asserted but not reviewable"; reason="The target phrase alone cannot demonstrate that it retains the source referent. The mapping artifact and proof reference, as well as the immutable ScopeTrail, are required."; remediation="Add the missing source, scope, mapping, or proof reference; do not convert the translation into a new ungoverned concept."; override="No reviewer can accept an untraceable translation."
```
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Attempt to accept without a reviewable source concept, scope movement, mapping artifact, mapping proof, or target review authority"; heading="Review acceptance refused: semantic continuity cannot be established"; reason="The current Profile 11 information allows source and proof references to be associated, but a reviewer must see all required anchors together. Missing evidence prevents an honest acceptance."; remediation="Restore the missing reference or return the translation for revision. If the missing relationship itself cannot be expressed, file an L8 revision proposal."; override="No acceptance may rest solely on the target wording."
```
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Attempt to set formalization=testable with SVE-022 failing"; heading="Testable formalization refused"; reason="The target state requires a passing SemanticVerificationEvidence record. SVE-022 is ontology-consistency evidence with a failing result, so DR-043 must remain structured."; remediation="Remediate the referenced inconsistency, obtain a new passing verification record, and re-evaluate. The existing effect receipt is not evidence that axioms are consistent."; override="No authority can mark a definition testable against a failing required record."
```
...
PageShell
  ...
  ScopeTrail
    payload: ordered-scope="City of Rivulet › Harbor District › 2026 Heat Safety Programme"; movement="Current decision scope"; editable="no"
  RefusalNotice
    payload: trigger="SVE-022 ontology-consistency result is failing"; heading="DR-043 cannot be treated as testable"; reason="SVE-022 reports a conflict between the proposed escorted-entry clause and the declared unrestricted-access axiom. The conflict is referenced at iri:fixture:verification/SVE-022/finding-04. A failing axiom set may not be presented as testable."; remediation="Revise the structured definition or its axioms, then obtain a new passing SemanticVerificationEvidence record. Until then, retain the current structured state and do not create a testability-dependent effect."; override="No override or hidden downgrade is available."
  PanelFrame
...
PageShell
  ...
  RefusalNotice
    payload: trigger="Request federated agreement with incomplete participant and proof set"; heading="Federation refused: agreement remains local"; reason="Local attestation SA-008 does not establish multi-party federation. The target member-municipality authority is not represented and the supplied mapping proof does not cover all required participants."; remediation="Obtain the missing participant attestation and complete mapping proof, then evaluate a FederationAgreement. If the required participant role cannot be represented by the profile, record an L8 revision proposal."; override="No federation can be declared."
```
