...
gem "vv-linkml",           path: "gems/vv-linkml"
gem "vv-code-search",      path: "gems/vv-code-search"
gem "vv-code-repo",        path: "gems/vv-code-repo"
gem "vv-self-learn",       path: "gems/vv-self-learn"
gem "vv-orinth",           path: "gems/vv-orinth"
gem "vv-canvas",           path: "gems/vv-canvas"
gem "vv-dependency-orch",  path: "gems/vv-dependency-orch"
gem "vv-browser",          path: "gems/vv-browser"
gem "mmg-medallion",       path: "gems/mmg-medallion"
gem "vv-medallion_memory", path: "gems/vv-medallion_memory"
gem "vv-bpmn-bbo",         path: "gems/vv-bpmn-bbo"
gem "vv-miro",             path: "gems/vv-miro"
gem "vv-figma",            path: "gems/vv-figma"
gem "vv-nooa",             path: "gems/vv-nooa"
gem "vv-use-case",         path: "gems/vv-use-case"
gem "vv-perch",            path: "gems/vv-perch"
gem "vv-sdlc",             path: "gems/vv-sdlc"
gem "vv-routing",          path: "gems/vv-routing"
gem "vv-mobile",           path: "gems/vv-mobile"
